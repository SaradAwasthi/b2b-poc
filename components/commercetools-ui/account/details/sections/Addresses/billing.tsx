...
const Addresses = () => {
  ...
  //user addresses
  const addresses = account?.addresses.slice(1, 2);
      ...
      <div className="divide-y divide-gray-200 ml-12">
        <div className="space-y-1">
          {/* <h3 className="text-lg font-medium leading-6 text-gray-900 dark:text-white">
            {formatAccountMessage({ id: 'address.myAddresses', defaultMessage: 'Billing Address' })}
          </h3> */}
          <h3 className="text-lg mt-2 font-medium leading-6 text-gray-900 dark:text-white">
            Billing Addresses
          </h3>
          <p className="max-w-2xl text-sm text-gray-500">
            {formatAccountMessage({
              id: 'billingAddress.desc',
              defaultMessage: 'Here you can add Billing addresses for your account',
            })}
          </p>
        </div>
        <div className="mt-6">
        ...
        <div className="py-4 sm:py-8">
          ...
          >
            {formatAccountMessage({ id: 'billingAddress.add', defaultMessage: 'Add an address' })}
          </button>
        </div>
      </div></div>
