...
import { headerNavigation, products } from 'helpers/mocks/mockData';
  ...
  return (
    <div className="fixed-screen-width lg:relative-width">
      ...
      <header className="relative">
        ...
        <nav aria-label="Top" className="order-gray-200 mx-auto max-w-full border-b bg-rc-brand-primary px-6 lg:px-8">
                ...
                <div className="flex h-full space-x-8">
                  ...
                  {links.map((link, id) => (
                    <ReferenceLink
                      ...
                      className="flex items-center text-3xl font-medium text-white hover:text-gray-500 dark:text-light-100"
                    >
              ...
              <div className="flex flex-1 items-center justify-end">
                <div className="flex w-fit items-center">
                  ...
                  <ReferenceLink target={logoLink} className="-m-2 p-2">
                    <button className="mr-5 rounded-full bg-white py-2 px-5 text-sm text-green-900 duration-300 hover:bg-gray-700 hover:text-white hover:drop-shadow-md">
                      PLP Page
                    </button>
                  </ReferenceLink>
