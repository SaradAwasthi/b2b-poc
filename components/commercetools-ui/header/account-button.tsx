    ...
    <div className="relative ml-4 flex items-center">
      {account ? (
        ...
        <div className="flex space-x-8">
          <div className="flex">
            <ReferenceLink target={accountLink} className="-m-2 p-2">
              <button className="rounded-full bg-white py-2 px-5 text-sm text-green-900 duration-300 hover:bg-gray-700 hover:text-white hover:drop-shadow-md">
                Login/Signin
              </button>
            </ReferenceLink>
          </div>
